...
$pageTitle = $pageTitle ?? __('order_picking_processing');
?>
<!DOCTYPE html>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card h-100 shadow-sm">
                            <div class="card-header header-primary d-flex justify-content-between align-items-center">
                                ...
                                <div id="managementActionsArea" class="d-none d-flex ms-auto me-3">
                                    <button id="printPickReportBtn" class="btn btn-sm btn-light me-2" disabled><i class="bi bi-file-earmark-text me-2"></i> <?php echo __('print_pick_report'); ?></button>
                                    <button id="printStickersBtn" class="btn btn-sm btn-danger me-2" disabled><i class="bi bi-printer me-1"></i> <?= __('print_stickers') ?></button>
                                </div>
