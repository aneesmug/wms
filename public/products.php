        ...
        <header class="bg-white shadow-sm border-bottom">
            <div class="container-fluid px-4">
                <div class="d-flex justify-content-between align-items-center py-3">
                    ...
                    <h1 class="h4 mb-0 text-dark mx-auto mx-md-0"><?php echo __('product_master_data'); ?></h1>
                    ...
                    <div class="card shadow-sm">
                        <div class="card-header header-primary d-flex justify-content-between align-items-center flex-wrap">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <label for="tireTypeFilter" class="form-label mb-0 me-2 text-nowrap"><?php echo __('filter_by_tire_type'); ?></label>
