...
<head>
    ...
    <title>WMS <?php echo __('supplier_management'); ?></title>
        ...
        <header class="bg-white shadow-sm border-bottom">
            <div class="container-fluid px-4">
                <div class="d-flex justify-content-between align-items-center py-3">
                    ...
                    <h1 class="h4 mb-0 text-dark mx-auto mx-md-0"><?php echo __('supplier_management'); ?></h1>
                ...
                <div class="container-fluid">
                    <div class="card shadow-sm">
                        <div class="card-header header-primary d-flex justify-content-between align-items-center">
                            <h5 class="card-title mb-0"><?php echo __('supplier_list'); ?></h5>
                            <div class="d-flex align-items-center gap-2">
                                <button id="addSupplierBtn" class="btn btn-light btn-sm"><i class="bi bi-plus-circle me-2"></i><?php echo __('add_new_supplier'); ?></button>
