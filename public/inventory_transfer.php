        ...
        <header class="bg-white shadow-sm border-bottom">
            <div class="container-fluid px-4">
                <div class="d-flex justify-content-between align-items-center py-3">
                    ...
                    <h1 class="h4 mb-0 text-dark mx-auto mx-md-0"><?php echo __('internal_inventory_transfer'); ?></h1>
                                ...
                                <form id="transferForm">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" id="availableQtyInput" class="form-control" readonly placeholder="Select a product">
                                        </div>
